...
user1.products.create(name: "Corsair LL140 Dual Light Loop, Twin Pack 140mm RGB LED PWM Fan with Lighting Node Pro", description: "LET YOUR LIGHTS DO THE TALKING
...
user1.products.create(name: "EZDIY-FAB New Dual Ring 120mm RGB LED Case Fans, 5V Motherboard Sync, Speed Adjustable, RGB Sync Fan with Fan Hub X and Remote-3 Pack", description: "16 Leds with true RGB with 16.8 million colors to light up your build with nearly endless customizable combinations
...
user1.products.create(name: "Corsair CO-9050039-WW ML120, 120mm Premium Magnetic Levitation Fan (2-Pack), No LED", description: "Magnetic Bearing: harnesses magnetic levitation technology to provide lower noise, higher performance, and a longer lifespan
...
user1.products.create(name: "Lian Li Lancool 215 Mesh ARGB Mid Tower E-ATX Case", description: "Model
...
E-ATX(width: under   280mm)/ATX/M-ATX/ITX
...
1 x Top (magnetic), 1 x Bottom (tray)", price: 129, category: cat1, default_image: "2")